...
function generatePreview(jsonFilePath) {
  ...
  console.log(`   ✓ Loaded data for: ${jsonData.businessName}\n`);
  ...
  console.log(`   ✓ Flattened ${Object.keys(flatData).length} placeholder values\n`);
  ...
  console.log(`   ✓ Replaced ${replacementCount} placeholders\n`);
  ...
  console.log('💾 Writing generated HTML...');
  ...
  console.log(`Output: previews/generated/${slug}/index.html`);
  console.log('═══════════════════════════════════════\n');
...
if (require.main === module) {
  ...
  try {
    ...
    console.log('🎉 Success! Open the generated file in your browser to view.\n');
